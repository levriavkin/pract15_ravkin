...
namespace zad4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            catalog.AddSong("Лучшее 2022", "МЕТАН", "Лирика");
            catalog.AddSong("Лучшее 2022", "Lizer", "Корабли");

            catalog.AddDisc("Фонк");
            catalog.AddSong("Фонк", "DVRST", "Close Eyes");
            catalog.AddSong("Фонк", "sovies", "kitty phonk");
